<?php
	...
	// Baris komentar: ....
	function hitung_tagihan_awal($jumlah_pesanan, $harga_satuan){
		$total_tagihan = $jumlah_pesanan * $harga_satuan;
		return $total_tagihan;
	}

	//	Instruksi Kerja Nomor 2.
	//	Variabel lokasi berisi data kota lokasi restoran dalam bentuk array.
	$daerah_jangkauan = array("Jakarta", "Bogor", "Depok", "Tangerang", "Bekasi");

	//	Instruksi Kerja Nomor 3.
	//	Mengurutkan array lokasi sesuai abjad A-Z.
	sort($daerah_jangkauan);

	//	Instruksi Kerja Nomor 4.
	//	Variabel untuk menyimpan harga satuan b	ento cake.
	$harga_satuan = 90000;
...
<html>
	...
	<div class="container border">
		...
		<img src="assets/img/logo.jpg" alt="Logo Perusahaan">
			...
			<div class="row">
				...
				<div class="col-lg-2">
					...
					<?php
						...
						foreach($daerah_jangkauan as $key => $value):
	...
	<?php
		...
		if(isset($_POST['Pesan'])) {
			...
			file_put_contents('assets/data/data.json', $dataJson);
			...
			$tagihanAwal = hitung_tagihan_awal($dataPesanan['jumlahPesanan'], $harga_satuan);

			//	Instruksi Kerja Nomor 9.
			//	Menghitung ongkos kirim berdasarkan lokasi dengan kontrol percabangan.
			if ($_POST['lokasi'] == array_search('Tangerang', $daerah_jangkauan)) {
				$ongkir = 5000;
			} elseif ($_POST['lokasi'] == array_search('Bogor', $daerah_jangkauan)) {
				$ongkir = 10000;
			} else {
				$ongkir = 0;
			}
